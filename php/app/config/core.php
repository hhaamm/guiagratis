 ...
 */
Configure::write('Security.salt', 'DYlKeoD93TlQIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '76859309048573942496749683645');
...
Configure::write('Mail.from', 'updates@guia-gratis.com.ar');
Configure::write('Mail.to', 'guiagratis@gmail.com');
Configure::write('Mail.complaint', 'guiagratis+complaint@gmail.com');
Configure::write('Host.siteName', 'http://www.guia-gratis.com.ar/');
Configure::write('Host.clean_url', 'www.guia-gratis.com.ar');
Configure::write('Host.url', 'http://'.Configure::read('Host.url').'/');
...
Configure::write('GoogleMaps.DefaultPoint', array('latitude' => -34.626204, 'longitude' => -58.462827));
Configure::write('GoogleMaps.DefaultAddress', 'Buenos Aires Argentina');

Configure::write('NoPhotoUrl', '/img/tmp/no_photo.jpg');
Configure::write('GeoTestIpAddress', '190.55.85.66');
Configure::write('IPInfoDB.ApiKey', 'bd682ca04a96bee3149b88bb35155884ef80d4dccf0ef230a962ac491c065d66');

Configure::write('ExchangeState.Published', 1);

Configure::write('ExchangeType.Request', 1);
